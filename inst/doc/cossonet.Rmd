...
vignette: >
  %\VignetteIndexEntry{This package provides a function for estimating sparse nonlinear components in nonparametric regression, specifically designed for high-dimensional data. The method is applicable to various types of data, including models from the exponential family and the Cox proportional hazards model.}
