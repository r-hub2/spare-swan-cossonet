...
When the function \texttt{cossonet} is running, the progress at each step is displayed in the console. At each step, cross-validation (CV) is performed and the mean squared error (MSE) of the training set evaluated with the optimal smoothing parameter selected by CV is displayed.
